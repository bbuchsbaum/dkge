...
`bd-01M03KTXQK53KJD0HF1K8Y39CM` and reused unchanged for dispersion ticket
`bd-01M0404W80JQKCANSTJ42NDPKX`.
...
| literal Poisson repool | O(B S q^2 P) conservatively | input records plus O(q^2) | P x P |

The last row is intentionally conservative: literal refits guarantee correct
random-effects and ruler semantics and are not advertised as a constant-time
bootstrap shortcut.
