...
4. **Weighting**: Compute optional subject MFA weights (`svd` per subject) and voxel weights, accumulating the compressed covariance `Chat`. Missingness policies (`none`, `mask`, `rescale`, `shrink`) restore **observed** pair mass under partial coverage, not full cohort mass.
