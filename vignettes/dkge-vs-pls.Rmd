...
| **Data normalisation** | Conditions averaged or mean-centred before SVD; each voxel treated equally. | Row standardisation of subject betas using shared rulers; optional spatial/reliability weights \(\Omega_s\). |
